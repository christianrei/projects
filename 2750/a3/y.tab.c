...
{
      14,     0,    -1,     4,     6,     7,    18,     7,    11,    -1,
      14,     4,     6,     7,    18,     7,    11,    -1,    14,     3,
       6,     8,    15,     9,    11,    -1,    14,     5,     6,     8,
      15,     9,    11,    -1,    14,    17,     6,     7,    18,     7,
      11,    -1,    16,    -1,    16,    10,    -1,    15,    16,    -1,
      15,    16,    10,    -1,     7,    18,     7,    -1,    12,    -1,
      12,    -1,    18,    12,    -1
};
...
{
  "$end", "error", "$undefined", "FIELDS", "TITLE", "BUTTONS", "EQUAL",
  "QUOTE", "LISTL", "LISTR", "COMMA", "SEMI", "STRING", "$accept", "PART",
  "LISTS", "ITEM", "CHECK", "MULTISTRING", 0
};
#endif
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,    14,     0,     0,     7,     0,     0,     0,     2,
       0,     0,     9,     8,     0,     0,     0,    11,     4,    10,
       3,     5,     6
};
...
{
      -3,    11,     0,    17,   -13,    19,    20,    21,   -13,    22,
      18,    23,    25,    26,    28,   -13,    -5,    29,    18,    29,
      18,    27,   -13,    18,    13,    30,     2,    14,     3,   -13,
       6,    31,    33,   -13,    34,    35,    36,   -13,   -13,   -13,
     -13,   -13,   -13
};
...
{
       4,     1,    21,     5,     6,     7,    26,    22,    28,    34,
      36,    30,     8,    37,    22,    22,    32,     3,    22,    32,
      23,    23,    31,    35,    10,    11,    12,    13,    14,    27,
      15,    17,    18,     0,    19,    20,    23,     0,    29,     0,
      33,     0,    38,    39,     0,    40,    41,    42
};

static const yytype_int8 yycheck[] =
{
       0,     4,     7,     3,     4,     5,    18,    12,    20,     7,
       7,    23,    12,     7,    12,    12,    24,     6,    12,    27,
       7,     7,     9,     9,     7,     6,     6,     6,     6,    19,
      12,     8,     7,    -1,     8,     7,     7,    -1,    11,    -1,
      10,    -1,    11,    10,    -1,    11,    11,    11
};
...
{
       0,     4,    14,     6,     0,     3,     4,     5,    12,    17,
       7,     6,     6,     6,     6,    12,    18,     8,     7,     8,
       7,     7,    12,     7,    15,    16,    18,    15,    18,    11,
      18,     9,    16,    10,     7,     9,     7,     7,    11,    10,
      11,    11,    11
};
...
#line 53 "parser.y"
  ...
  case 13:
#line 76 "parser.y"
    {if(type==0)titleList->name = strdup(yytext);
    else if(type==1) {
  ...
  case 14:
#line 97 "parser.y"
    {if(type==0)addToBack(titleList,strdup(yytext));
    else if(type==1) {
        addToBack(fieldList,strdup(yytext));
        fieldCount++;
    }
